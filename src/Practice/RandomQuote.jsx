...
function RandomQuote() {
  ...
  const [randomQuote, setRandomQuote] = useState(
    a[0].quotes[Math.floor(Math.random() * a[0].quotes.length)]
  );

  const generateRandomQuote = () => {
    const randomIndex = Math.floor(Math.random() * a[0].quotes.length);
    setRandomQuote(a[0].quotes[randomIndex]);
  };
  ...
  return (
    <div style={{ textAlign: 'center', padding: '20px' }}>
      ...
      <button onClick={generateRandomQuote} style={{ padding: '10px 20px' }}>
